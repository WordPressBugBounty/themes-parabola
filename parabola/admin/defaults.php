...
"parabola_side" => "2cSr",
"parabola_sidewidth" => 920,
"parabola_sidebar" => 280,
"parabola_mobile" => "Enable",
"parabola_zoom" => 0,
"parabola_hcontain" => "",

"parabola_frontpage" => "Disable",
"parabola_frontposts" => "Enable",
"parabola_frontpostscount" => get_option('posts_per_page'),
"parabola_frontpostsperrow" => '2',

"parabola_fpborderwidth" => "0",
"parabola_fpsliderwidth" => "1200",
"parabola_fpsliderheight" => "500",
"parabola_fpslideranim" => "sliceDown",
"parabola_fpslidertime" => "650",
"parabola_fpsliderpause" => "5000",
"parabola_fpslidernav" => "Bullets",
"parabola_fpsliderarrows" => "Visible on Hover",

"parabola_slideShortcode" => "",
"parabola_slideType" => "Custom Slides",
"parabola_slideCateg" => "",
"parabola_slideNumber" => "5",
"parabola_slideSpecific" => "",

"parabola_sliderimg1" => esc_url( get_template_directory_uri() )."/images/slider/parabola-slide1.jpg",
...
"parabola_sliderimg2" => esc_url( get_template_directory_uri() )."/images/slider/parabola-slide2.jpg",
"parabola_slidertitle2" => "",
"parabola_slidertext2" => "",
"parabola_sliderlink2" => "",
"parabola_sliderimg3" => esc_url( get_template_directory_uri() )."/images/slider/parabola-slide3.jpg",
"parabola_slidertitle3" => "This is yet another caption title",
"parabola_slidertext3" => 'There is again content for the slide and you can use <a href="#">links</a> and other type of <b>HTML</b> <i>tags</i> to make this more interesting.',
...
"parabola_columnType"	=> "Custom Columns",
"parabola_nrcolumns" => "3",
"parabola_columnNumber"	=> "3",
"parabola_colimageheight" => "278",
"parabola_colimagewidth" => "356",
"parabola_columnreadmore" => "Read more",
"parabola_columnCateg"	=> "",
"parabola_columnSpecific"	=> "",

"parabola_columnimg1" => esc_url( get_template_directory_uri() )."/images/columns/parabola-column1.jpg",
...
"parabola_columnlink1" => "#",
"parabola_columnimg2" => esc_url( get_template_directory_uri() )."/images/columns/parabola-column2.jpg",
"parabola_columntitle2" => "You can use HTML tags",
"parabola_columntext2" => 'You can also use <a href="#">links</a> as well as most <strong>other</strong> <u>HTML</u> <em>tags</em> and even [shortcodes] inside the columns.',
"parabola_columnlink2" => "#",
"parabola_columnimg3" => esc_url( get_template_directory_uri() )."/images/columns/parabola-column3.jpg",
...
"parabola_fronttitlecolor" => "#111111",
"parabola_fpsliderbordercolor" => "#ffffff",
"parabola_fpslidercaptioncolor" => "#333333",
"parabola_fpslidercaptionbg" => "#ffffff",
...
"parabola_image_style" => "parabola-image-four",
